...
export default function RatingStar({ color = '#fcc419', size = 24, MaxRating = 10, setMovieRating }) {
    ...
    const HandleRatingStar = (temprating) => {
...
const Star = ({ color, size, setRating, HandleResetRating, full, handelRating }) => {
    const StarStyle = {
        height: `${size}px`,
        width: `${size}px`,
        display: ' block',
